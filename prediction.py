...
def alarm_pred(dataframe):
    ...
    output_df_false.to_csv('false_alarm_report.csv')
    ...
    df_cat3 = pd.read_csv(r"combine_rulebook.csv")
    ...
    print(report)
    report.to_csv("alarm_action_report.csv")
    ...
    dupdf.to_csv('duplication_alarm_report.csv')
